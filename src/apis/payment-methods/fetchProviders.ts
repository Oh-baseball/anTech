...
type FetchProvidersResponse = PaymentProvider;

const fetchProviders = async (): Promise<APIResponse<FetchProvidersResponse>> => {
  try {
    const response = await axiosInstance.get<APIResponse<FetchProvidersResponse>>(
